...
"""
    ...
    def test_ios_osg_core_blend_state_uses_the_same_gl4es_owner_as_draws(self) -> None:
        ...
        self.assertEqual(3, self.osg_route.count("if (enabled) gl4es_glEnable(mode);"))
        self.assertEqual(3, self.osg_route.count("else gl4es_glDisable(mode);"))
        self.assertIn("manualBlendCacheMatch", self.osg_route)
